  ...
  return (
    <div>
      <section className="sub-banner">
        <h1>Paise Bhejo APP</h1>
        <img src="image/Group 12.svg" alt="" className="phone" />
      ...
      <section className="feature">
        ...
        <div>
          ...
          <img src="image\Screen2.svg" alt="" className="screen" />
          {/* <span className="mask">
      ...
      <section className="downloadapp">
        <div>
          <div>
            <h2>Download Paisa Bhejo App</h2>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
        ...
        <img src="image/Group 11.svg" alt="" />
      </section>
    </div>
  );
};
